...
from eval_utils.utils import FIXED_COT_PROMPT_DIRECT
import os
...
def format_4_way_judge_answers(question, answer_a, answer_b, answer_c, answer_d, model):
